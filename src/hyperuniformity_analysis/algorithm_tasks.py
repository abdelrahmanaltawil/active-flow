...
def density_fourier(kx: np.ndarray, ky: np.ndarray, extrema_snapshots: dict) -> np.ndarray:
    '''
    Placeholder
    '''
...
def _density_fourier(kx: np.ndarray, ky: np.ndarray, extrema: np.ndarray) -> np.ndarray:
    ...
    density = np.zeros((len(kx), len(kx)), dtype=np.complex128)
...
def radial_profile(kx: np.ndarray, ky: np.ndarray, structure_factor_snapshots: dict, center: tuple) -> np.ndarray:
    '''
    Placeholder
    '''
...
def _radial_profile(kx: np.ndarray, ky: np.ndarray, structure_factor: np.ndarray, center: tuple) -> np.ndarray:
    '''
    Placeholder
    '''
